...
// Dribbble widget for kiwi WordPress theme

include_once(ABSPATH . WPINC . '/feed.php');

class kiwi_dribbble_widget extends WP_Widget {

	function __construct() {
        $widget_ops = array( 
			'classname' 	=> 	'kiwi_dribbble_widget', 
			'description' 	=> 	__( 'Muestra tus últimas fotos de Dribbble.', 'kiwi' ) 
		);

        parent::__construct( 'kiwi_dribbble_widget', __( 'Dribbble Widget', 'kiwi' ), $widget_ops );
    }
		...
		if ( ! empty( $widget_title ) ) {
			...
			if ( ! empty( $items ) ) : ?>
				...
				<div class="dribbble-container">
					...
					<p class="widgetmore"><a href="http://www.dribbble.com/<?php echo esc_url( $dribbble_user ); ?>"><?php printf( __( 'Siga %s en Dribbble &raquo;', 'kiwi' ), $dribbble_username); ?></a></p>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_username'); ?>"><?php  _e('Nombre de usuario Dribbble', 'kiwi'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_number'); ?>"><?php _e('Número de imágenes para mostrar:', 'kiwi'); ?>
...
register_widget( 'kiwi_dribbble_widget' ); ?>