		...
		<div class="posts">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="content-inner">
					...
					<div class="post-header">
						...
						<div class="post-meta">
							...
							<span><?php echo __( 'Cargada', 'kiwi' ) . ' ' . get_the_time( get_option( 'date_format' ) ); ?></span>
							
							<span class="date-sep">/</span>
						
							<span><?php echo __( 'Anchura:', 'kiwi' ) . ' ' . $image_array[1] . ' px'; ?></span>
							
							<span class="date-sep">/</span>
							
							<span><?php echo __( 'Altura:', 'kiwi' ) . ' ' . $image_array[2] . ' px'; ?></span>
				...
				<div class="post-nav">
					...
					<a href="<?php echo esc_url( $prev_attachment_url ); ?>" class="post-nav-older" rel="attachment"><?php _e( '&laquo; <span>Archivo adjunto</span> anterior', 'kiwi' ); ?></a>
					<a href="<?php echo esc_url( $next_attachment_url ); ?>" class="post-nav-newer" rel="attachment"><?php _e( 'Siguiente <span>archivo adjunto</span> &raquo;', 'kiwi' ); ?></a>
